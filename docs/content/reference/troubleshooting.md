...
Most of these come down to network reality or how twitch serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

twitch rate-limits like any public site. twitch already paces
...
Where a surface is gated, twitch reads a cookie or token you supply
